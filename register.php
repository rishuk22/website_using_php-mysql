      ...
      <div class="col-lg-8 col-xl-6">
        <div class="card rounded-3">
          ...
          <div class="card-body p-4 p-md-5">
            ...
            <form class="px-md-2" method="post" action="reg_process.php" >
              ...
              <label class="form-label" for="form3Example1q">UserName</label>
                <input type="text" id="form3Example1q" placeholder="Write a unique username" class="form-control" name="username" />
              ...
              <label class="form-label" for="form3Example1q">DOB</label>
                <input type="date" id="form3Example1q" class="form-control" name="dob" />
                
              </div>

              <div data-mdb-input-init class="form-outline mb-4">
              <label class="form-label" for="form3Example1q">Mobile_no.</label>
                <input type="number" id="form3Example1q" placeholder="type_your_number" class="form-control" name="num" />
              ...
              <a href="index.php">back_to_home</a><br>

            </form>
            <br>
            <div class="card-footer">
                <small>&copy; VibeSphere</small>
            </div>
